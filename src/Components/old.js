      ...
      <HashRouter>
        <div className="App">
          <nav className="navbar  navbar-expand-lg navbar-fixed-top ">
            <ul className="navbar-nav mr-auto">
              <li className="nav-item">
                <NavLink to="/Help">
                  <i className="fa fa-question">Help &nbsp;</i>
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink to="nav-link" href="/Storelocator">
                  <i className="fa fa-home">Store locator</i>
                </NavLink>
              </li>
            </ul>
            <ul className="navbar-nav ml-auto">
              <li className="nav-item">
                <NavLink to="nav-link" href="/Contactus">
                  <i className="fa fa-mobile">Contact us &nbsp; </i>
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink to="/login">
                  <i className="fa fa-users"> Signin</i>
                </NavLink>
                &nbsp;
              </li>
              <li className="nav-item">
          ...
          <div className="logo">
            ...
            <p>MATHRUKA NATURAL WELLNESS STORE</p>
          </div>
            ...
            <nav>
              <ul class="nav">
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      <NavLink to="/itema">Itema</NavLink>
                    </li>
                    <li>
                      <NavLink to="/itemb">Itemb</NavLink>
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    <li>
                      <a href="/">item a long submenu</a>
                    </li>
                    <li>
                      <NavLink to="/itemc">itemc</NavLink>
                      <ul>
                        <li>
                          <NavLink to="/itemd">itemd</NavLink>
                        </li>
                      </ul>
                    </li>
                    <li>
                      <NavLink to="/iteme">iteme</NavLink>
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    <li>
                      <NavLink to="/itemf">itemf</NavLink>
                    </li>
                  </ul>
                </li>
              </ul>
